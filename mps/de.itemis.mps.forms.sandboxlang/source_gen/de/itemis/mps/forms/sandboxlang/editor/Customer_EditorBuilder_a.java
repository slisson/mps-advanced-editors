...
/*package*/ class Customer_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_sygm7r_a3a1a0");
    Style style = new StyleImpl();
    new labelStyleClass(getEditorContext(), getNode()).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new addressesListHandler_sygm7r_b3a1a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_addresses");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class addressesListHandler_sygm7r_b3a1a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public addressesListHandler_sygm7r_b3a1a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(addressesListHandler_sygm7r_b3a1a0.this.getNode(), LINKS.addresses$603c));
      try {
