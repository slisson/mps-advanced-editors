...
/*package*/ class AddressTabHeader_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AddressTabHeader_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createMathBase_0(EditorContext editorContext, SNode node) {
    ...
    final boolean[] shared_isActive = new boolean[1];
    ...
    EditorCell_MathBase editorCell = new EditorCell_MathBase(editorContext, node, layout, scales, symbols) {
      protected void paint(Graphics2D g, List<MathLayoutableCell> childCells, MathLayoutableCell cell, List<IMathSymbol> symbols) {
        ...
        g.setColor((shared_isActive[0] ? new Color(100, 200, 100) : new Color(90, 130, 90)));
        g.fill(rr);
      ...
      protected void init(SNode node, List<MathLayoutableCell> childCells, MathLayoutableCell cell, List<IMathSymbol> symbols) {
        shared_isActive[0] = (boolean) Address__BehaviorDescriptor.isActive_id5fk$COuKfsm.invoke(myNode);
      }
    };
    editorCell.setCellId("MathBase_8gxabr_a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.getInstance().<Boolean>getAttribute("de.itemis.mps.editor.math", "side-tranformation-helper-cells"), _StyleParameter_QueryFunction_8gxabr_a0a());
  ...
  private boolean _StyleParameter_QueryFunction_8gxabr_a0a() {
    return false;
  }
